...
dados = """school_id,ano,municipio,rede,taxa_evasao,ideb,infra_index,renda_media,desemprego,risco_evasao
...
# Transformar a string em um objeto de arquivo
dados_io = StringIO(dados)

# Ler usando pandas
df = pd.read_csv(dados_io)

# Gerar o CSV na pasta atual
